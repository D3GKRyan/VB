...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "Name A Button"
        Me.Button1.UseVisualStyleBackColor = True
        '
        'TextBox1
        '
        Me.TextBox1.Location = New System.Drawing.Point(97, 52)
        ...
        Me.Label2.Text = "Now go to page 46 in the book and start on the tutorial"
        '
        'Form1
        '
